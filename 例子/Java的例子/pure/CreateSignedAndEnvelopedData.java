...
public class CreateSignedAndEnvelopedData {

	public static void main(String[] args) throws Exception{
		if(args.length!=4) {
            System.out.println("Usage: java CreateSignedAndEnvelopedData enCert signCert infile outfile");
            return;
        }
	...
	private static Signer createSigner(X509Certificate cert,NetcaMyStore store) throws Exception{
    	...
    	AlgorithmIdentifier algo=AlgorithmIdentifier.CreateAlgorithmIdentifierNullParam(AlgorithmIdentifier.SHA256WithRSA_OID);
