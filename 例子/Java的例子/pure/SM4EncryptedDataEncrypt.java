...
public class SM4EncryptedDataEncrypt {
	...
	public static void main(String[] args) throws Exception{
		...
		int encAlgo=EncryptedDataBuilder.SM4;
		int hashAlgo=EncryptedDataBuilder.SM3;
		byte[] clear=readFile(inFileName);
		
		Pkcs5PBKDF2 kdf=new Pkcs5PBKDF2(new NetcaHasher());
		EncryptedData encryptedData=EncryptedDataBuilder.getQ7Instance()
			.setEncryptAlgorithm(encAlgo)
			.setPkcs5KDFImplement(kdf, hashAlgo,32, 8192)
			.setPwd(pwd)
