...
if arg_count!=3:
    print("Usage: python signeddataverifywithtimestamp1.py sign_file_name tbs_file_name")
    sys.exit(-1)

tbs_file_name=sys.argv[2]
sign_file_name=sys.argv[1]

with SignedData.new_verify_object() as sign_obj,open(sign_file_name,"rb") as f_in,open(tbs_file_name,"wb") as f_out:
