...
if arg_count!=3:
    print("Usage: python envelopeddatadecrypt4.py env_file_name clear_file_name")
    sys.exit(-1)

clear_file_name=sys.argv[2]
env_file_name=sys.argv[1]

with EnvelopedData(False) as env_obj,open(clear_file_name,"wb") as f_out,open(env_file_name,"rb") as f_in:
