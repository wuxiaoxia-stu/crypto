...
function Usage(scriptName)
    ...
    print(ToANSIString("\t对inFileName文件进行SM4 CCM模式的加密或者解密运算，结果保存到outFileName文件中"))
end

function NewSm4Ccm(enc,key,nonce,tLen,aad,p)
...
cipherObj=assert(NewSm4Ccm(enc,key,nonce,tLen,adata,dataLen))
