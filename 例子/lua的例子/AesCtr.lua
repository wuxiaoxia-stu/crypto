...
function Usage(scriptName)
    ...
    print(ToANSIString("\t对inFileName文件进行AES CTR模式的加密或者解密运算，结果保存到outFileName文件中"))
end

function NewAesCtr(enc,key,iv,bits)
...
cipherObj=assert(NewAesCtr(enc,key,iv,countBits))
