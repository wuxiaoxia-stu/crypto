...
function Usage(scriptName)
    ...
    print(ToANSIString("\t对inFileName文件进行SM4 CTR模式的加密或者解密运算，结果保存到outFileName文件中"))
end

function NewSm4Ctr(enc,key,iv,bits)
...
cipherObj=assert(NewSm4Ctr(enc,key,iv,countBits))
