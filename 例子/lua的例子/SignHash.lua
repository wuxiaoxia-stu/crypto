...
function Usage(filename)
    print(string.format("Usage: lua %s cert signAlgo hashValue outFileName [pwd]",filename))
...
local data=keypair:SignHash { ["algo"]=algo,["hash"]=hashValue }
keypair:Free()
if data==nil then
...
if Save(outFileName,data)==false then
