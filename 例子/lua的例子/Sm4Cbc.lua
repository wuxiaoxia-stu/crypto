...
function Usage(scriptName)
    print(string.format("lua %s /e|/d key iv inFileName outFileName",scriptName))
    ...
    print(ToANSIString("\t对inFileName文件进行SM4 CBC模式的加密或者解密运算，结果保存到outFileName文件中"))
end

function NewSm4Cbc(enc,key,iv)
...
cipherObj=assert(NewSm4Cbc(enc,key,iv))
