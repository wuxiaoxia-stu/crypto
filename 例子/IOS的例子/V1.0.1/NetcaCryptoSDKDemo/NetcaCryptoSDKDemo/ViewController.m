...
- (void)testSign {
    ...
    signatureInterface.signCert = signCertList[0];
    signatureInterface.signAlgo = NetcaSignAlgorithmSHA256WithRSA;
...
- (void)testSignedDataSign {
    ...
    signedDataInterface.signCert = signCertList[0];
    signedDataInterface.signAlgo = NetcaSignAlgorithmSHA256WithRSA;
...
- (void)testSign_BigFile {
    ...
    int algo = NetcaSignAlgorithmSHA256WithRSA;
...
- (void)testSignedDataSign_BigFile {
    ...
    signedDataSignInterface.signCert = signCertList[0];
