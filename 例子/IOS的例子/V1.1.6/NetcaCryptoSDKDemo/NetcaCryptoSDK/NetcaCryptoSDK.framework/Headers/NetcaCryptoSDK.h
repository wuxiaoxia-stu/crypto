...
#import "NetcaPinManageSystemInterface.h"
#import "NetcaMobileKeyInterface.h"
...
/**
 ...
 @return 返回设备接口实例
 */
- (NetcaDeviceInterface *_Nonnull)getDeviceInterface;
...
/**
 ...
 @return 返回证书接口实例
 */
- (NetcaCertInterface *_Nonnull)getCertInterface;
