...
/* CRL URL */
@property(nonatomic, strong, nullable, readonly) NSString *crlURL;
/* OCSP URL */
@property(nonatomic, strong, nullable, readonly) NSString *ocspURL;
/* 扩展密钥用法 */
@property(nonatomic, copy, readonly) NSArray<NSString *> *extKeyusage;
@property(nonatomic, copy, readonly) NSString *keypairLabel;
...
/**
 ...
 @param oid oid
 @return 证书扩展值的UTF-8字符串
 */
- (nullable NSString *)extensionValueOf:(NSString *)oid;
/**
 获取证书属性
 ...
 @return 证书属性h值
 */
- (nullable NSString *)stringAttributeOf:(int)attrId;
@end
