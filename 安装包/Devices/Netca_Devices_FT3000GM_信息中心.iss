...
#define SETUP_FILE_VERSION "3.0.0.1"
#define UID  "F31F18B8-F917-4C32-803D-C8BA821590AE"
[Setup]
; 注: AppId的值为单独标识该应用程序。
; 不要为其他安装程序使用相同的AppId值。
; (生成新的GUID，点击 工具|在IDE中生成GUID。)
AppId={{F31F18B8-F917-4C32-803D-C8BA821590AE}
...
OutputBaseFilename=NETCA_Devices(FT3000GM)信息中心版
Compression=lzma
...
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyFT3000GM; ValueType: multisz; ValueName: idstring; ValueData: Vid_096E&Pid_0314{break}Vid_096E&Pid_0317; Flags: uninsdeletekey; Check: not IsWin64
...
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyFT3000GM\CCID; ValueType: multisz; ValueName: idstring; ValueData: Vid_096E&Pid_0314; Flags: uninsdeletekey; Check: not IsWin64
...
Root: HKLM; SubKey: SOFTWARE\Wow6432Node\NETCA\PKI\Devices\NETCAKeyFT3000GM; ValueType: multisz; ValueName: idstring; ValueData: Vid_096E&Pid_0314{break}Vid_096E&Pid_0317; Flags: uninsdeletekey; Check: IsWin64
...
Root: HKLM; SubKey: SOFTWARE\Wow6432Node\NETCA\PKI\Devices\NETCAKeyFT3000GM\CCID; ValueType: multisz; ValueName: idstring; ValueData: Vid_096E&Pid_0314; Flags: uninsdeletekey; Check: IsWin64
...
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyFT3000GM; ValueType: multisz; ValueName: idstring; ValueData: Vid_096E&Pid_0314{break}Vid_096E&Pid_0317; Flags: uninsdeletekey; Check: IsWin64
...
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyFT3000GM\CCID; ValueType: multisz; ValueName: idstring; ValueData: Vid_096E&Pid_0314; Flags: uninsdeletekey; Check: IsWin64
