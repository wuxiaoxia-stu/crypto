...
#define DEVICES_APPNAME "网证通设备驱动_MWScard(32&64)"
...
OutputBaseFilename=NETCA_Devices(MWScard)
Compression=lzma
...
;32位系统动态设备DLL(32位)
Source: ..\..\winX86\设备驱动\明华卡\广一医院\MWScardProv.dll_device.ini; DestDir: {pf}\NETCA\NETCA_Devices; Flags: uninsrestartdelete ignoreversion; Check: not IsWin64
Source: ..\..\winX86\设备驱动\明华卡\广一医院\MWScardProv.dll; DestDir: {pf}\NETCA\NETCA_Devices; Flags: uninsrestartdelete ignoreversion; Check: not IsWin64
Source: ..\..\winX86\设备驱动\明华卡\广一医院\MWScardProv.dll_driver.ini; DestDir: {pf}\NETCA\NETCA_Devices; Flags: uninsrestartdelete ignoreversion; Check: not IsWin64

;32位系统动态设备DLL(32位)
Source: ..\..\winX86\设备驱动\明华卡\广一医院\MWScardProv.dll_driver.ini; DestDir: {pf32}\NETCA\NETCA_Devices; Flags: uninsrestartdelete ignoreversion; Check: IsWin64
Source: ..\..\winX86\设备驱动\明华卡\广一医院\MWScardProv.dll; DestDir: {pf32}\NETCA\NETCA_Devices; Flags: uninsrestartdelete ignoreversion; Check: IsWin64
Source: ..\..\winX86\设备驱动\明华卡\广一医院\MWScardProv.dll_device.ini; DestDir: {pf32}\NETCA\NETCA_Devices; Flags: uninsrestartdelete ignoreversion; Check: IsWin64

;64位系统动态设备DLL(64位)
Source: ..\..\winX64\设备驱动\明华卡\MWScardProv.dll; DestDir: {pf}\NETCA\NETCA_Devices\; Flags: uninsrestartdelete ignoreversion; Check: IsWin64
Source: ..\..\winX64\设备驱动\明华卡\MWScardProv.dll_device.ini; DestDir: {pf}\NETCA\NETCA_Devices\; Flags: uninsrestartdelete ignoreversion; Check: IsWin64
...
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: string; ValueName: dllpath; ValueData: {pf}\NETCA\NETCA_Devices\MWScardProv.dll; Flags: uninsdeletekey; Check: not IsWin64
...
Root: HKLM; SubKey: SOFTWARE\Wow6432Node\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: string; ValueName: dllpath; ValueData: {pf32}\NETCA\NETCA_Devices\MWScardProv.dll; Flags: uninsdeletekey; Check: IsWin64
...
;64位系统64位注册表
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: dword; ValueName: mustLogin; ValueData: $00000000; Flags: uninsdeletekey; Check: IsWin64
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: string; ValueName: dllpath; ValueData: {pf}\NETCA\NETCA_Devices\MWScardProv.dll; Flags: uninsdeletekey; Check: IsWin64
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: string; ValueName: signature; ValueData: qq8M1LCfr6uy9LyOVLyEaqjlPLxul062K+BGFDD63/IltFX3s+2CEqZsNrSB635geNMZTbaP5O12u16bIEXfDbI3ygIsnQg0x7f7INHTTojiv+7N/4Kei/9UpC/tOP1y2jkIy2QSSfrAsBYEzJHn2dsX8Vqhy7x8R74/HROAEyg=; Flags: uninsdeletekey; Check: IsWin64
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: string; ValueName: class; ValueData: PC/SC; Flags: uninsdeletekey; Check: IsWin64
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: dword; ValueName: type; ValueData: $0000002d; Flags: uninsdeletekey; Check: IsWin64
Root: HKLM; SubKey: SOFTWARE\NETCA\PKI\Devices\NETCAKeyMWScard; ValueType: multisz; ValueName: idstring; ValueData: ACS ACR1281 1S Dual Reader PICC 0; Flags: uninsdeletekey; Check: IsWin64
...
NewUninsName := 'Unins_MWScard(32&64)';
