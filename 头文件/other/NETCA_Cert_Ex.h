...
/*
 *		netca_cert_dn_getasn1
 *			获取NETCA_CERT_X500_DN中的ASN.1结构
 *		参数：
 *			dn：NETCA_CERT_X500_DN句柄
 *		返回值：
 *			成功返回ASN.1结构,失败返回NULL
 */
NETCA_X500Name_Ptr NETCAAPI netca_cert_dn_getasn1(NETCA_CERT_X500_DN dn);
